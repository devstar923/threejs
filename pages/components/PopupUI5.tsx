...
const PopupUI5 = (props: any) => {
  ...
  const src =
    "https://bifesbuker.co.id/user/profile?a=1&u=anZ6RndQMHhmTW1VVjJVeVQ2cEZ3blhGTUlxZVFlL3FhM0Rra24wWkNzMD07bFlxV0EvVXRwNnlVdENtNFBxNzV6eVVlQTh2bGQxSjRaRzV4YzhRd2UvUT0l4iLa&" +
    props.mode;
  ...
  return (
    <>
      <div
        ...
        style={{
          display: popUpIndex === 5 ? "block" : "none",
          zIndex: 2000000000,
        }}
      >
