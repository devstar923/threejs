...
const PopupUI4 = (props: any) => {
  ...
  const src =
    "https://fitforgrowth.id/upcoming_product?u=cjE5b21HVFZjUFJSc1FYYi9adHJzbks2Ym1NMnRsVldVYm5tY2t0cGJCOD07bFlxV0EvVXRwNnlVdENtNFBxNzV6eVVlQTh2bGQxSjRaRzV4YzhRd2UvUT0l4iLa&" +
    props.mode;
  ...
  useEffect(() => {
    ...
    var iframe_html =
      '<iframe id="phoneFrame4" class="w-full h-full ml-2" src="' +
      src +
      '"></iframe>';
  ...
  return (
    <>
      <div
        ...
        style={{
          display: popUpIndex === 4 ? "block" : "none",
          zIndex: 2000000000,
        }}
      >
