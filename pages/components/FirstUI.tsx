  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{ display: showIntro ? "none" : "block" }}
          className="go-button absolute left-0 bottom-16 w-screen h-auto"
        >
        ...
        <div
          style={{ display: showIntro ? "block" : "none" }}
          className="go-button absolute left-0 bottom-16 w-screen h-auto z-99"
        >
          <div className="w-screen flex justify-center">
            <button
              className="relative w-[114px] h-[114px] flex justify-center items-center pointer-events-auto"
