...
const PopupUI1 = (props: any) => {
  ...
  const src =
    "https://bifesbuker.co.id/infogames?a=1&u=anZ6RndQMHhmTW1VVjJVeVQ2cEZ3blhGTUlxZVFlL3FhM0Rra24wWkNzMD07bFlxV0EvVXRwNnlVdENtNFBxNzV6eVVlQTh2bGQxSjRaRzV4YzhRd2UvUT0l4iLa&" +
    props.mode;
  ...
  useEffect(() => {
    ...
    var iframe_html =
      '<iframe id="phoneFrame1" class="w-full h-full ml-2" src="' +
      src +
      '" ></iframe>';
  ...
  return (
    <>
      <div
        ...
        style={{
          display: popUpIndex === 1 ? "block" : "none",
          zIndex: 2000000000,
        }}
      >
